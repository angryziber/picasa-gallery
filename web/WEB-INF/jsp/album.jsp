...
<head>
  ...
  <meta name="keywords" content="${fn:replace(album.nickname,' ',',')},photos,${fn:replace(album.title.plainText, " ", ",")},${fn:replace(fn:replace(album.description.plainText, ", ", " "), " ", ",")}">
  ...
  <c:if test="${photo != null}">
    ...
    <c:if test="${fn:length(photo.description.plainText) > 0}">
